...
int main() {
	...
	const auto &minutes = most_slept_minute[most_sleep_guard];
	int max = std::distance(minutes.begin(), std::max_element(minutes.begin(), minutes.end()));
	printf("guard %d slept %dh:%dm on %dm most of the time\n", most_sleep_guard, most_sleep_time/60, most_sleep_time%60, max);
